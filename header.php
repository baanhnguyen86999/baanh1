      ...
      <nav class=" navbar navbar-expand-lg navbar-light container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="nav navbar-nav m-auto">
            <li class=" nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="dropdown-item dropdown">
                  <a href="./productList.php?gender=1">Rượu mạnh <i class="fas fa-chevron-right dropdown-icon"></i></a>
                  <!-- Sub menu level 2 -->
                  
                </li>
                <li class="dropdown-item dropdown">
                  <a href="./productList.php?gender=2">Rượu vang <i class="fas fa-chevron-right dropdown-icon"></i></a>
                  <!-- Sub menu level 2 -->
            ...
            <li class="line"></li>
            <li class=" nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="./productList.php?gender=1" id="navbarDropdown">Rượu cho nam <span class="caret"></span></a>
              
            </li>

            <li class="line"></li>
            <li class=" nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="./productList.php?gender=2" id="navbarDropdown">Rượu cho nữ<span class="caret"></span></a>
          ...
          <div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active" data-interval="3000">
                <div class="cont-item d-block w-100 text-center"><a href="./productList.php">Flash Sale các loại rượu !</a></div>
              </div>
              <div class="carousel-item" data-interval="3000">
                <div class="cont-item d-block w-100  text-center"><a href="./productList.php">Rượu bị chua hoặc mùi vị khó uống có thể đổi lại để kiểm thử</a></div>
              </div>
              <div class="carousel-item" data-interval="3000">
