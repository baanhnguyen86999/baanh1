                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0">
                                Hóa đơn
                                <span class="totalPriceOfCart"><span id="totalCart"><?php echo formatCurrency(getTotalCart($id_cart))?></span>1900000 VNĐ</span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                                ...
                                <h4><strong><span id="tempPrice"><?php echo formatCurrency(getTotalCart($id_cart))?></span>1900000 VND</strong></h4>
                            </li>
                        </ul>
