...
<div class="cartfixed d-none d-md-block  hidden-xs hidden-sm" data-target="#shop_cart" data-toggle="collapse">
    ...
    <div id="shop_cart" class="cart collapse">
        ...
        <ul class="list-group">
            ...
            <!-- LIST ITEM IN CART -->
            <li class="list-group-item divider"></li>
            <li class="list-group-item total"><span class="float-left">Tổng cộng:</span><span class="float-right tright"><?php echo formatCurrency(getTotalCart($id_cart)); ?>500000 VNĐ</span></li>
