                        ...
                        <div class="panel-group" id="prdDetailInfor" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="panel-body">
                                        <h6>
                                            <ul>                                               
                                                ...
                                                <li>Sản phẩm đổi không có dấu hiệu đã qua sử dụng, không giặt tẩy, bám bẩn, biến dạng.</li>                                                                         <li>Không hoàn trả bằng tiền mặt dù bất cứ trong trường hợp nào. Mong bạn thông cảm.</li>
                                            </ul>
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                    ...
                                    <div class="panel-body">
                                        <h6>
                                            <p>Cam kết mang đến những dòng sản phẩm đảm bảo chất lượng 100%.Với đầy đủ Tem Mác của Nhà sản xuất và Tem nhập khẩu.Nếu quý khách hàng phát hiện hàng giả,hàng kém chất lượng,WineSTORE sẽ đền bù gấp 10 lần cho các bạn và chúng tôi sẽ chịu trách nhiệm hoàn toàn trước pháp luật.Chính vì vậy quý khách hoàn toàn yên tâm khi sử dụng dịch vụ của chúng tôi.:</p>
                                            <p>155, Cầu Giấy, quận Quan Hoa, Hà Nội<br>
                                                Hotline: 0962550759 </p>
                                        </h6>
                                    </div>
                                </div>
